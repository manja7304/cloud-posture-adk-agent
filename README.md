...
Security teams face backlog and false-positive fatigue in **CSPM misconfiguration detection**. This repo demonstrates a production-style **Tool Calling (ADK)** agent using **Google ADK**.

ADK-style tool-calling agent checking mock CIS controls with structured findings JSON.
...
|---------|------------|------------------------|
| Tool Calling (ADK) | Core agent flow | Simple prompt chain |
